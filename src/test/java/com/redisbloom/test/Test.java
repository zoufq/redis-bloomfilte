...
import com.redisbloom.redis.RedisBitSetNotCluster;
...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        ...
        RedisBitSet bitSet = new RedisBitSetNotCluster(pool,"redisbitname");
        bloomFilter.bind(bitSet);
        System.out.println(bloomFilter.contains("zfq_jusfoun"));
        bloomFilter.add("zfq_jusfoun");
        System.out.println(bloomFilter.contains("zfq_jusfoun"));
        /*
